  ...
  ngOnInit(): void {
	...
	resolved(captchaResponse: string) {
      ...
      if (this.usertype == null || this.usertype === '') {
        ...
        this.action = 'Please specify if you are user or admin.';
        this.validate = false;
      }
      ...
      this.httpWebService.createNewUser(this.username, this.password, this.aadhaar, this.PAN, this.occupation, this.firstname, this.lastname, this.dob, this.phone, this.address, this.city, this.state, this.country, this.zip,this.usertype);
