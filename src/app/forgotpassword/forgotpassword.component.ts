  ...
  verifyUser() {
    if (this.username != null || this.username !== '') {
      if (EMAIL_REGEX.test(this.username)) {
        ...
        this.httpWebService.createNotification(this.username, 'Password Change Request', this.errorDetl + ' If you did not request this change immediately contact us at support@rrs.in');
      } else {
