...
import { ManageAccountComponent } from './user-dashboard/manage-account/manage-account.component';
import { HttpClientModule } from '@angular/common/http';
import { StationUpdateComponent } from './admin-dashboard/station-update/station-update.component';
...
const appRoutes: Routes = [
  ...
  { path: 'admin', component: AdminComponent, children: [
    ...
    {path: 'stationUpdate',component: StationUpdateComponent},
  ...
  { path: 'user', component: UserComponent,  children: [
    ...
    { path: 'myaccount', component: ManageAccountComponent },
    { path: 'editaccount/:id', component: ManageAccountComponent },
...
@NgModule({
  ...
  providers: [HttpWebService,HttpClient,HttpClientModule],
